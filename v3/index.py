...
normal_cases = [f"{normal_cases_dir}/{i}" for i in os.listdir(normal_cases_dir)]
Tuberculosis_cases = [f"{Tuberculosis_cases_dir}/{i}" for i in os.listdir(Tuberculosis_cases_dir)]
